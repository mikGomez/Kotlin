...
class MainActivity2 : AppCompatActivity() {
    ...
    fun descripcion(p : Simpson){
        ...
        if (p.nombre.equals("Snake",true)){
            ...
            binding.txtDescripcion.text = "Era un arqueólogo que había encontrado monedas de oro,que pensaba donar al museo,pero al estar desprevenido moe se la roba,snake jura venganza y se convierte en un criminal,usualmente roba la tienda de apu y le dispara," +
        ...
        if (p.nombre.equals("hommer",true)){
            ...
            binding.txtDescripcion.text = "Homer está desempleado y sin dinero. Para mantener a su esposa y a su hijo que venía en camino, consiguió un trabajo en la planta nuclear de Montgomery Burns como inspector de seguridad, gracias a la campaña de igualdad de oportunidades.\n" +
        ...
        if (p.nombre.equals("bart",true)){
            ...
            binding.txtDescripcion.text = "Bart es decididamente el más rebelde y travieso de la familia. Es un muchacho simpático y también muy travieso, que hace muchas bromas con su mejor amigo Milhouse. Sigue los programas de su ídolo Krusty el Payaso. Es desobediente y hace todo lo que le pasa por la cabeza. Su nombre es un anagrama de \"brat\", que en inglés significa \"travieso\". " +
